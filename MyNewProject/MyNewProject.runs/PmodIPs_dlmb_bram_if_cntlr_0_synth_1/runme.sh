...
HD_PWD='D:/Users/Daniel/Documents/VivadoProjects/MyNewProject/MyNewProject.runs/PmodIPs_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodIPs_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodIPs_dlmb_bram_if_cntlr_0.tcl
