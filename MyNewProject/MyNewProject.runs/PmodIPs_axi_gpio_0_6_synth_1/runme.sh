...
HD_PWD='D:/Users/Daniel/Documents/VivadoProjects/MyNewProject/MyNewProject.runs/PmodIPs_axi_gpio_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodIPs_axi_gpio_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodIPs_axi_gpio_0_6.tcl
