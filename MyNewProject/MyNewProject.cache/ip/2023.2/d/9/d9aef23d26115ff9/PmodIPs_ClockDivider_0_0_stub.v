...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk_in, reset_in, BUTTON, LED, clk_out, reset_out)
/* synthesis syn_black_box black_box_pad_pin="clk_in,reset_in,BUTTON,LED,clk_out,reset_out" */;
  input clk_in;
  input reset_in;
  input BUTTON;
  output LED;
