...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk_in, clk_out, axilite_aclk, axilite_aresetn, 
  ...
  axilite_arvalid, axilite_arready, axilite_rdata, axilite_rvalid, axilite_rready, divisor)
/* synthesis syn_black_box black_box_pad_pin="clk_out,axilite_aclk,axilite_aresetn,axilite_awaddr[31:0],axilite_awvalid,axilite_awready,axilite_wdata[31:0],axilite_wvalid,axilite_wready,axilite_bresp[1:0],axilite_bvalid,axilite_bready,axilite_araddr[31:0],axilite_arvalid,axilite_arready,axilite_rdata[31:0],axilite_rvalid,axilite_rready,divisor[15:0]" */
