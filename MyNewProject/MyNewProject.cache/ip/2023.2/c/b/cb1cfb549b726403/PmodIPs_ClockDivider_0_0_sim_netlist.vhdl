...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute x_interface_info of axilite_aclk : signal is "xilinx.com:signal:clock:1.0 axilite_aclk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of axilite_aclk : signal is "XIL_INTERFACENAME axilite_aclk, ASSOCIATED_BUSIF axilite, ASSOCIATED_RESET axilite_aresetn, FREQ_HZ 81248000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, INSERT_VIP 0";
  attribute x_interface_info of axilite_aresetn : signal is "xilinx.com:signal:reset:1.0 axilite_aresetn RST";
  attribute x_interface_parameter of axilite_aresetn : signal is "XIL_INTERFACENAME axilite_aresetn, POLARITY ACTIVE_LOW, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of axilite_awaddr : signal is "XIL_INTERFACENAME axilite, DATA_WIDTH 32, PROTOCOL AXI4LITE, FREQ_HZ 81248000, ID_WIDTH 0, ADDR_WIDTH 32, AWUSER_WIDTH 0, ARUSER_WIDTH 0, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, READ_WRITE_MODE READ_WRITE, HAS_BURST 0, HAS_LOCK 0, HAS_PROT 0, HAS_CACHE 0, HAS_QOS 0, HAS_REGION 0, HAS_WSTRB 0, HAS_BRESP 1, HAS_RRESP 0, SUPPORTS_NARROW_BURST 0, NUM_READ_OUTSTANDING 1, NUM_WRITE_OUTSTANDING 1, MAX_BURST_LENGTH 1, PHASE 0.0, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0";
...
begin
  axilite_arready <= \<const0>\;
  axilite_bresp(1) <= \<const0>\;
  axilite_bresp(0) <= \<const0>\;
  axilite_bvalid <= \<const0>\;
  axilite_rdata(31) <= \<const0>\;
  axilite_rdata(30) <= \<const0>\;
  axilite_rdata(29) <= \<const0>\;
  axilite_rdata(28) <= \<const0>\;
  axilite_rdata(27) <= \<const0>\;
  axilite_rdata(26) <= \<const0>\;
  axilite_rdata(25) <= \<const0>\;
  axilite_rdata(24) <= \<const0>\;
  axilite_rdata(23) <= \<const0>\;
  axilite_rdata(22) <= \<const0>\;
  axilite_rdata(21) <= \<const0>\;
  axilite_rdata(20) <= \<const0>\;
  axilite_rdata(19) <= \<const0>\;
  axilite_rdata(18) <= \<const0>\;
  axilite_rdata(17) <= \<const0>\;
  axilite_rdata(16) <= \<const0>\;
  axilite_rdata(15) <= \<const0>\;
  axilite_rdata(14) <= \<const0>\;
  axilite_rdata(13) <= \<const0>\;
  axilite_rdata(12) <= \<const0>\;
  axilite_rdata(11) <= \<const0>\;
  axilite_rdata(10) <= \<const0>\;
  axilite_rdata(9) <= \<const0>\;
  axilite_rdata(8) <= \<const0>\;
  axilite_rdata(7) <= \<const0>\;
  axilite_rdata(6) <= \<const0>\;
  axilite_rdata(5) <= \<const0>\;
  axilite_rdata(4) <= \<const0>\;
  axilite_rdata(3) <= \<const0>\;
  axilite_rdata(2) <= \<const0>\;
  axilite_rdata(1) <= \<const0>\;
  axilite_rdata(0) <= \<const0>\;
  axilite_rvalid <= \<const0>\;
  axilite_wready <= \<const0>\;
